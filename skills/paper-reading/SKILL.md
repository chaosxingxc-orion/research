...
### 2. 结构化阅读
1. **Abstract**: 获取整体概览
2. **Introduction**: 了解背景和研究问题
3. **Methods**: 理解研究设计和方法
4. **Results**: 关注主要发现
5. **Discussion**: 理解意义和局限
...
1. **批量筛选**: 先快速筛选大量论文，再深度阅读重要论文
2. **主动阅读**: 带着问题阅读，做笔记，提问
3. **交叉引用**: 注意论文之间的引用关系
4. **定期总结**: 定期整理和总结阅读内容
5. **工具辅助**: 使用文献管理工具和笔记软件

## 常见问题

**Q: 如何处理大量论文？**
A: 使用三遍阅读法：快速筛选、重点阅读、深度研读

**Q: 如何提高阅读效率？**
A: 使用标准化模板、专注于关键部分、做结构化笔记

**Q: 如何避免遗忘？**
A: 定期回顾笔记、建立知识体系、与同事讨论

## 相关资源

- [How to Read a Paper](http://ccr.sigcomm.org/online/files/p83-keshavA.pdf)
- [The Three-Pass Approach](https://web.stanford.edu/class/ee384m/Handouts/HowtoReadPaper.pdf)
- [Paper Reading Tools](https://www.papersapp.com/)
